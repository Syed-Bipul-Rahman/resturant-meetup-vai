...
export default function Title({ title, description, className = 'text-[#171717]', descriptionClass = 'text-[#646f79]', visible = true }: ITitleProps) {
    return (
        <div className='space-y-3'>
            <h1 className={`${className} text-2xl md:text-3xl lg:text-5xl font-bold  capitalize !leading-[1.2]`}>{title}</h1>
            ...
            <p className={`${descriptionClass} text-[#646f79] text-md lg:text-lg`}>
                {description}
            </p>
        </div>
    )
